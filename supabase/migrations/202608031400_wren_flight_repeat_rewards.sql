-- Keep Wren Flight rewards fair on every qualifying flight.
...
begin
  ...
  if v_source_policy.repeat_multiplier_bps = 10000 and v_source_policy.score_target <= 8 then return; end if;
  ...
  insert into public.game_reward_policies (
    ...
    10000, v_source_policy.daily_cap, 8, now()
  );
