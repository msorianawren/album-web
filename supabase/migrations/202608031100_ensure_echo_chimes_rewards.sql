-- Ensure the published Echo Chimes version has a verified reward policy.
...
begin
  ...
  if found
     and v_source_policy.base_reward = 12
     and v_source_policy.maximum_reward = 30
     and v_source_policy.repeat_multiplier_bps = 2500
     and v_source_policy.daily_cap = 90
     and v_source_policy.score_target = 8 then
    return;
  end if;
