-- Give committed Wren Flight players room for a full daily play session.
...
begin
  ...
  if v_source_policy.daily_cap >= 300 then return; end if;
  ...
  insert into public.game_reward_policies (
    ...
    v_source_policy.repeat_multiplier_bps, 300, v_source_policy.score_target, now()
  );
