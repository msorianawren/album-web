...
export const sampleAlbums: AlbumDetail[] = [
  ...
  },
  {
    ...
    owner_id: ownerId,
    title: "Where Morning Lingers",
    slug: "where-morning-lingers",
    description: "A serene morning study with soft natural light and subtle chime atmosphere.",
    status: "public",
    cover_url: summerMedia[0].thumbnail_url,
    cover_media_id: summerMedia[0].id,
    photo_count: 3,
    ...
    created_at: now,
    updated_at: now,
    media: summerMedia.map((m) => ({ ...m, album_id: "00000000-0000-0000-0000-000000000009" })),
    download_allowed: true,
    locked: false,
  },
  {
