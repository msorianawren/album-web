...
const registryEntries: EnvironmentState[] = [
  state("none", "day", { clearColor: "#f5eee9", keyLight: "#fff1d8", fillLight: "#c9ddeb", keyIntensity: 1.35, ambientIntensity: 0.78, fogColor: "#efe5e4", fogNear: 8, fogFar: 22, branchColor: "#625048", foliage: ["#f8d9df", "#efb7c5", "#e8c9c0"], particle: ["#f7cbd5", "#fff1ee"], chimeReflection: 1, birdActivity: 0, birdSong: 0, wind: 0, fireflies: 0 }),
  state("none", "sunset", { clearColor: "#ead3c8", keyLight: "#ffb986", fillLight: "#c9a8c7", keyIntensity: 1.55, ambientIntensity: .62, fogColor: "#dcbeb9", fogNear: 7, fogFar: 20, branchColor: "#5a403b", foliage: ["#f1b8c1", "#ffcfbd", "#d98fa5"], particle: ["#ffc3bd", "#ffe0ce"], chimeReflection: 1.25, birdActivity: 0, birdSong: 0, wind: 0, fireflies: 0 }),
  state("none", "night", { clearColor: "#182331", keyLight: "#a8c9ef", fillLight: "#53647e", keyIntensity: .9, ambientIntensity: .36, fogColor: "#263548", fogNear: 6, fogFar: 18, branchColor: "#2b2830", foliage: ["#b7a8bd", "#d4c2ce", "#7f7288"], particle: ["#dac7d5", "#8eaee0"], chimeReflection: .7, birdActivity: 0, birdSong: 0, wind: 0, fireflies: 0 }),
  ...
  state("fireflies", "day", { clearColor: "#cce0cf", keyLight: "#e9f1c9", fillLight: "#8caf93", keyIntensity: 1.15, ambientIntensity: .72, fogColor: "#b2ccb9", fogNear: 7, fogFar: 21, branchColor: "#4b5947", foliage: ["#5e7a54", "#8ca36b", "#43593b"], particle: ["#e0e89f", "#edf1ce"], chimeReflection: .75, birdActivity: .8, birdSong: .72, wind: .75, fireflies: .04 }),
  state("fireflies", "sunset", { clearColor: "#576b4a", keyLight: "#ffce70", fillLight: "#547366", keyIntensity: 1.4, ambientIntensity: .48, fogColor: "#58694d", fogNear: 6, fogFar: 18, branchColor: "#2b3323", foliage: ["#828a41", "#597042", "#a6934c"], particle: ["#ffd659", "#b9db60"], chimeReflection: .9, birdActivity: .62, birdSong: .46, wind: .7, fireflies: .48 }),
  state("fireflies", "night", { clearColor: "#041416", keyLight: "#529486", fillLight: "#152e31", keyIntensity: .5, ambientIntensity: .25, fogColor: "#0a1f22", fogNear: 5, fogFar: 16, branchColor: "#131a17", foliage: ["#1e362d", "#2d4a3e", "#14261f"], particle: ["#ffea75", "#c6f28d"], chimeReflection: .48, birdActivity: .08, birdSong: .02, wind: .55, fireflies: 1 }),
