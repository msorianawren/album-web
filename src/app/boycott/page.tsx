...
export default async function BoycottPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      <AppHeader />
      <section className="mx-auto flex min-h-[78vh] w-full max-w-4xl items-center px-4 py-16 sm:px-8">
        <article className="w-full border border-border bg-surface px-7 py-10 shadow-2xl shadow-text-primary/10 sm:px-12 sm:py-14">
          <p className="text-sm uppercase tracking-[0.28em] text-text-secondary">
            Notice from the administrator
          </p>
          <h1 className="mt-6 font-serif text-4xl leading-tight text-text-primary sm:text-5xl">
            A letter regarding your access
          </h1>
          <div className="mt-8 space-y-5 font-serif text-xl leading-9 text-text-primary">
            <p>Dear visitor,</p>
            <p>
            ...
            <p className="text-2xl italic">The administration</p>
          </div>
        </article>
      </section>
    </main>
