...
import { appendUserHelpMessage, classifyHelpWriteFailure, getUserHelpThread } from "@/lib/help-chat";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try { return NextResponse.json({ success: true, message: await appendUserHelpMessage({ session, client, threadId: idResult.data, body: parsed.data.body, request }) }, { headers: noStore }); }
  catch (error) {
